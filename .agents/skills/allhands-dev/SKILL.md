...
Full contract: `AGENTS.md`. Full architecture: `product/04-architecture.md`. Principle refresh context: [ADR 0011](../../../product/adr/0011-principles-refresh.md).
