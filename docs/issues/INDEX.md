...
最后更新:2026-04-19(Track K 关闭 I-0019 gateway 嵌套 · accordion + ping 状态机 + L01 成对 + demo 预设)
...
- 2026-04-19 · Track K 关闭 I-0019(/gateway master-detail → accordion · PingIndicator 4 态状态机 · `POST /api/models/{id}/ping` + `allhands.meta.ping_model` 成对 · bootstrap_service.ensure_gateway_demo_seeds 首装 3 providers × 7 models · 6+5+5 后端用例 + 3 playwright smoke · P1 3 → 2)
