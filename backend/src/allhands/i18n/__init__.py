...
_MESSAGES: dict[str, dict[str, str]] = {
    "zh-CN": {
        ...
        "errors.not_found.attachment": "附件不存在",
        "errors.attachment.not_image": "附件不是图片",
        "errors.attachment.pil_unavailable": "PIL 不可用,无法生成缩略图",
        "errors.attachment.read_failed": "读取附件失败:{detail}",
        "errors.audio.no_bytes": "适配器返回了空音频",
        ...
        "artifacts.revert_default": "回退到 v{version}",
    ...
    "en": {
        ...
        "errors.not_found.attachment": "Attachment not found",
        "errors.attachment.not_image": "Attachment is not an image",
        "errors.attachment.pil_unavailable": "PIL not available; cannot generate thumbnail",
        "errors.attachment.read_failed": "Failed to read attachment: {detail}",
        "errors.audio.no_bytes": "Adapter returned no audio bytes",
        ...
        "artifacts.revert_default": "Reverted to v{version}",
